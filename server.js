    ...
    view: {
      ...
      blocks: [
        ...
        },
        {
          ...
          hint: { type: "plain_text", text: "Max 250 characters." },
          element: { type: "plain_text_input", action_id: "value", multiline: true, max_length: 250, placeholder: { type: "plain_text", text: "Describe the purpose of this channel..." } },
        },
      ],
    },
  });
